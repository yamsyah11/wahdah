...
<head>
  ...
  <title>Sekolah Wahdah Islamiyah Bombana</title>
  <!-- plugins:css -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
              <form action="config/proses_login.php" method="post">
                ...
                <div class="form-group d-flex justify-content-between" style="margin-left: 100px;">
                  <a href="data.php" class="text-small forgot-password text-black">Keseluruhan Gaji Guru</a>
                </div>

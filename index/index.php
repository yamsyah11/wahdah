            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="jabatan/add.php"><button class="file-upload-browse btn btn-info" type="button" style="margin-left: 940px;">Create</button></a>
    ...
    return $hasil_rupiah;
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { // while untuk memunculkan perbaris // row untuk memunculkan 
                          ...
                          <tr>    
                            ...
                            <td>
                            <a href='jabatan/edit.php?id=".$row['id_jabatan']."' style='text-decoration: none;color: #fff'>
                        <button type='button' class='btn social-btn btn-facebook'>
                          Edit</button></a>
                          <a href='jabatan/delete.php?id=".$row['id_jabatan']."' style='text-decoration: none;color: #fff'>

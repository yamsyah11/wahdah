...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../../script/images/favicon.png" />
</head>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Bonus Guru</h4>

                        <?php
                        include '../../config/koneksi.php';
                        $id = $_GET['id'];
                        $nomor = 1;
                        $sql   = "select * from bonus where id_bonus = $id";
                        $result = mysqli_query($konek, $sql);
                        $data = mysqli_fetch_assoc($result);
                        $value = $data['bonus'];
                      ?>
                  <form class="form-sample" action="edit_p.php" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="bonus" value="<?= $data['bonus'] ?> " />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4">
                            <div class="form-radio" style="display: flex; justify-content: space-between;">
                                   <div>
                              <a href="../bonus.php" class="btn btn-light">Cancel</a>
                              </div>
                              <button type="submit" class="btn btn-success mr-2" style="margin-left: 80px;">Submit</button>
                            </div>
                          </div>
                        </div>
                      </div>

            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="bonus/add.php"><button class="file-upload-browse btn btn-info" type="button" style="margin-left: 954px;">Create</button></a>
                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { // while untuk memunculkan perbaris // row untuk memunculkan 
                          ...
                          <tr>    
                            ...
                            <td>".$row['bonus']."</td>
                            <td>
                          <a href='bonus/edit.php?id=".$row['id_bonus']."' style='text-decoration: none;color: #fff'>
                        <button type='button' class='btn social-btn btn-facebook'>
                          Edit</button></a>
                          <a href='bonus/delete.php?id=".$row['id_bonus']."' onclick='javascrip:return confirm(\"Apakah anda yakin menghapus data?\")' style='text-decoration: none;color: #fff'>
